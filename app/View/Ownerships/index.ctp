<div class="ownerships index">
	...
	<tr>
		...
		<td><?php echo h($ownership['Ownership']['name']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $ownership['Ownership']['id']), array(), __('Are you sure you want to delete # %s?', $ownership['Ownership']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
