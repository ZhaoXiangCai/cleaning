<div class="clientTypes index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $clientType['ClientType']['id']), array(), __('Are you sure you want to delete # %s?', $clientType['ClientType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
