...
<?php echo $this->Form->create('OrderStatusesCleaningOrder'); ?>
	<fieldset>
		<legend><?php echo __('Edit Order Statuses Cleaning Order'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('OrderStatusesCleaningOrder.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('OrderStatusesCleaningOrder.id'))); ?></li>
