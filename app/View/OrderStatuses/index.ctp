<div class="orderStatuses index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $orderStatus['OrderStatus']['id']), array(), __('Are you sure you want to delete # %s?', $orderStatus['OrderStatus']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
