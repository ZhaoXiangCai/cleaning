...
<h2><?php echo __('Comment Type'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($commentType['CommentType']['color']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Category'); ?></dt>
		<dd>
			<?php echo h($commentType['CommentType']['category']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Comment Type'), array('action' => 'delete', $commentType['CommentType']['id']), array(), __('Are you sure you want to delete # %s?', $commentType['CommentType']['id'])); ?> </li>
